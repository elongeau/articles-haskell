...
On peut également composer des fonctions, on à alors une nouvelle fonction:
...
On voit qu'elle prend 2 fonctions en paramètres et retourne une fonction `a -> c`, que se passe t-il à l'intérieur ?
