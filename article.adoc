...
Et bien parce que Haskell est un langage fonctionnel et est donc tout à fait adapté à cet article.
...
[source,haskell]
----
λ> add 1 2 -- toujours des espaces pour séparer les paramètres
3
----
...
On voit qu'elle prend 2 fonctions en paramètres et retourne une fonction `a -> c` (__higher order function FTW__),
