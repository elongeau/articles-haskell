...
Même si comme moi vous n'utilisez pas un langage strictement fonctionnel au jour le jour j'espère que cela vous apportera une autre approche de votre code.
